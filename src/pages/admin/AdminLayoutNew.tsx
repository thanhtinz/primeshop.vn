...
const getNavConfig = (t: (key: string) => string): { standalone: NavItem[], groups: NavGroup[] } => ({
  ...
  groups: [
    ...
    },
    {
      ...
      pathPrefix: '/admin/hero-banners|/admin/news|/admin/reviews|/admin/posts|/admin/partners',
      items: [
    ...
    },
    {
      ...
      items: [
        ...
        { icon: Mail, labelKey: 'admin.mailServer', label: 'Mail Server', path: '/admin/mail-server' },
